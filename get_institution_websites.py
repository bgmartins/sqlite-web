...
def websites_Sindicais():
	...
	websites_sindicais = open("./institution-websites/websites_sindicais.txt", "w",encoding="utf8")
...
def websites_Patronais():
	...
	websites_patronais = open("./institution-websites/websites_patronais.txt", "w",encoding="utf8")
