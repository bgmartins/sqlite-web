...
CREATE TABLE CAE_SECCOES_TEMP( SECCAO CHAR(1) PRIMARY KEY , TITLE VARCHAR(100) , SALARY FLOAT );
CREATE TABLE CAE_SECCOES_KEYWORDS_TEMP( SECCAO CHAR(1) , KEYWORD VARCHAR(100) , FOREIGN KEY(SECCAO) REFERENCES CAE_SECCOES_TEMP );

INSERT INTO CAE_SECCOES_TEMP VALUES ( 'A' , 'AGRICULTURA, PRODUÇÃO ANIMAL, CAÇA, FLORESTA E PESCA', 726.3);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'B' , 'INDÚSTRIAS EXTRACTIVAS', 867.2);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'C' , 'INDÚSTRIAS TRANSFORMADORAS', 868.5);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'D' , 'ELECTRICIDADE, GÁS, VAPOR, ÁGUA QUENTE E FRIA E AR FRIO', 867.2);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'E' , 'CAPTAÇÃO, TRATAMENTO E DISTRIBUIÇÃO DE ÁGUA; SANEAMENTO GESTÃO DE RESÍDUOS E DESPOLUIÇÃO', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'F' , 'CONSTRUÇÃO', 798.3);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'G' , 'COMÉRCIO POR GROSSO E A RETALHO; REPARAÇÃO DE VEÍCULOS AUTOMÓVEIS E MOTOCICLOS', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'H' , 'TRANSPORTES E ARMAZENAGEM', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'I' , 'ALOJAMENTO, RESTAURAÇÃO E SIMILARES', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'J' , 'ACTIVIDADES DE INFORMAÇÃO E DE COMUNICAÇÃO', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'K' , 'ACTIVIDADES FINANCEIRAS E DE SEGUROS', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'L' , 'ACTIVIDADES IMOBILIÁRIAS', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'M' , 'ACTIVIDADES DE CONSULTORIA, CIENTÍFICAS, TÉCNICAS E SIMILARES', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'N' , 'ACTIVIDADES ADMINISTRATIVAS E DOS SERVIÇOS DE APOIO', 953.7);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'O' , 'ADMINISTRAÇÃO PÚBLICA E DEFESA; SEGURANÇA SOCIAL OBRIGATÓRIA', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'P' , 'EDUCAÇÃO', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'Q' , 'ACTIVIDADES DE SAÚDE HUMANA E APOIO SOCIAL', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'R' , 'ACTIVIDADES ARTÍSTICAS, DE ESPECTÁCULOS, DESPORTIVAS E RECREATIVAS', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'S' , 'OUTRAS ACTIVIDADES DE SERVIÇOS', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'T' , 'ACTIVIDADES DAS FAMÍLIAS EMPREGADORAS DE PESSOAL DOMÉSTICO E ACTIVIDADES DE PRODUÇÃO DAS FAMÍLIAS PARA USO PRÓPRIO', NULL);
INSERT INTO CAE_SECCOES_TEMP VALUES ( 'U' , 'ACTIVIDADES DOS ORGANISMOS INTERNACIONAIS E OUTRAS INSTITUIÇÕES EXTRA-TERRITORIAIS', NULL);
